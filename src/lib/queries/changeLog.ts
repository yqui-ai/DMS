...
/* The display rules live in ../changeLogText — pure, and therefore testable. Re-exported here so
   every caller keeps importing one module. */
export * from '../changeLogText';
import { entityLabel, type ChangeEntry } from '../changeLogText';
